...
<form action="Views/Administrador/equipos/integrantes.php?id_equipo=<?php echo $_GET['id_equipo']; ?>" method="POST" autocomplete="FALSE">
    <div class="card">
        <div class="card-header text-center">
               <span class="text-muted" style="font-size: 15px;font-weight: bold;">Datos del jugador a modificar</span> 
        </div>
        <div class="card-body">
            <div class="container">
                <div class="row">
                    <input type="hidden" name="id_jugador" value="<?php echo $_GET['id_jugador']; ?>">
                    <input required type="hidden" name="id_equipo" value="<?php echo $_GET['id_equipo']; ?>">

                    <div class="col-12 col-lg-3">
                        <label for="nombre" class="form-label">Nombre: </label>
                        <input required type="text" name="nombre" class="form-control" id="nombre" value="<?php echo $jugador->nombre; ?> ">
                    </div>

                    <div class="col-12 col-lg-2">
                        <label for="edad" class="form-label ">Edad </label>
                        <input required type="number" name="edad" class="form-control" id="edad" value="<?php echo $jugador->edad; ?>">
                    </div>

                    <div class="col-12 col-lg-2">
                        <label for="es_capitan" class="form-label">¿Es capitán?</label>
                        <select required name="es_capitan" id="es_capitan" class="form-select" aria-label="Default select example">
                    ...
                    <div class="col-12 col-lg-3">
                        ...
                        <input required type="text" name="correo" class="form-control" id="correo" value="<?php echo $jugador->correo; ?>">
                    </div>

                    <div class="col-12 col-lg-2">
                        <label for="id_licenciatura" class="form-label">Licenciatura</label>
                        <select required name="id_licenciatura" id="id_licenciatura" class="form-select">
                            <option value="" disabled>Opciones</option>
                            <?php
