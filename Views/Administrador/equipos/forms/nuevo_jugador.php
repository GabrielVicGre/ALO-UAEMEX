    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-3">
                ...
                <input type="text" name="nombre" placeholder="Ingresa tu nombre" class="form-control" id="nombre">
            </div>
            <div class="col-12 col-lg-2">
                <label for="edad" class="form-label">Edad</label>
                <input type="number" min="15" max="40" placeholder="Ingresa tu edad" name="edad" class="form-control" id="edad">
            </div>
            <div class="col-12 col-lg-2">
            ...
            <div class="col-12 col-lg-3">
                ...
                <input type="text" name="correo" placeholder="Ingresa tu correo" class="form-control" id="correo">
            </div>
            <div class="col-12 col-lg-2">
