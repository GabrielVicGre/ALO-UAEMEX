<?php
$equipos =  $equiController->getDatosEquipoById($_GET['id_equipo']);
?>
...
<form action="Views/Administrador/equipos/index.php" method="POST" autocomplete="FALSE">
    <div class="mb-3">
        ...
        ?>
            ...
            <input type="text" name="nombre" class="form-control" id="nombre" value="<?php echo $registro->nombre; ?> ">

            <label for="descripcion" class="form-label mt-4">Descripción: </label>
            <input type="text" name="descripcion" class="form-control" id="descripcion" value="<?php echo $registro->descripcion; ?> ">

            <label for="fecha_registro" class="form-label mt-4">Fecha Registro:</label>
            <input type="date" name="fecha_registro" class="form-control" id="fecha_registro" value="<?php echo $registro->fecha_registro ?>">
