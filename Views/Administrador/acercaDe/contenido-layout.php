    ...
    <div class="row py-lg-3">
        <div class="col-lg-8 col-md-8 mx-auto">
            ...
            <div class="text-center">
                <img src="Assets/Images/logotipo.png" style="width: 38%;" class="img-fluid" alt="...">
            </div>
            <p>
                <a href="Views/Administrador/inicio/index.php" class="btn btn-secondary my-3">Regresar al inicio</a>
