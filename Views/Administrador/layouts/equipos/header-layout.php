            ...
            <div class="position-sticky pt-3 sidebar-sticky">
                <ul class="nav flex-column ">
                    <li class="nav-item mx-1 mt-3">
                        <a class="nav-link text-white" aria-current="page" href="Views/Administrador/inicio.php">
                            <i class="bi bi-house-fill  mx-2"></i>
                            Inicio
                        </a>
                    </li>
                    <li class="nav-item mx-1">
                        <a class="nav-link text-white selected" href="Views/Administrador/equipos.php">
                            <i class="bi bi-people-fill mx-2"></i>
                            Equipos
                        </a>
                    </li>
                    <li class="nav-item mx-1">
                        <a class="nav-link text-white" href="Views/Administrador/calendario.php">
                            <i class="bi bi-calendar2-week-fill mx-2"></i>
                            Calendario
                        </a>
                    </li>
                    <li class="nav-item mx-1">
                        <a class="nav-link text-white" href="Views/Administrador/clasificaciones.php">
                            <i class="bi bi-bar-chart-line-fill mx-2"></i>
                            Clasificaciones
                        </a>
                    </li>
                    <li class="nav-item mx-1">
                        <a class="nav-link text-white" href="Views/Administrador/canchas.php">
                ...
                <ul class="nav flex-column mb-2 mx-1">
                    <li class="nav-item">
                        <a class="nav-link text-white" href="Views/Administrador/acercaDe.php">
                            <i class="bi bi-info-circle mx-2"></i>
                            Acerca de
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="Views/Administrador/ayuda.php">
