            ...
            <div class="position-sticky pt-3 sidebar-sticky">
                <ul class="nav flex-column ">
                    <li class="nav-item mx-1 mt-3">
                        <a class="nav-link text-white selected" aria-current="page" href="Views/Administrador/inicio.php">
                            <i class="bi bi-house-fill  mx-2"></i>
                            Inicio
                        </a>
                    </li>
                    <li class="nav-item mx-1">
                        <a class="nav-link text-white" href="Views/Administrador/equipos.php">
